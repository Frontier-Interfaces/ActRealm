...
> **Project status:** functional implementation is complete through M14, but
> the current source remains a local test candidate rather than a final v1
> release. Real-Provider M13 acceptance and the continuous 48-hour Runtime
> stability gate are still pending.
